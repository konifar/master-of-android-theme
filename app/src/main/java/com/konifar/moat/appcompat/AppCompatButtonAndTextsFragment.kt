...
class AppCompatButtonAndTextsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding: AppcompatButtonsAndTextsFragmentBinding = DataBindingUtil.inflate(layoutInflater, R.layout.appcompat_buttons_and_texts_fragment, container, false)
        return binding.root
    }
